    ...
    <nav className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="https://github.com/Naveen27K/filedeck"
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-800 bg-slate-900/60 text-slate-400 hover:text-white hover:border-slate-700 transition-all duration-200 hover:bg-slate-800/80 shadow-sm"
      ...
      {isOpen && (
        <div className="md:hidden border-t border-slate-850 bg-slate-950 px-4 py-3 space-y-1">
          ...
          <div className="px-3 py-2 flex items-center justify-between border-t border-slate-900 mt-2 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-800 bg-slate-900/60 text-slate-400 hover:text-white hover:border-slate-700 transition-all"
              title="View on GitHub"
            >
              <GithubIcon className="h-5 w-5" />
            </a>
